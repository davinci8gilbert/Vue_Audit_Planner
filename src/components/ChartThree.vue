<template>
    <div>
      <div class="chartthree-container"><canvas id="myChartThree"></canvas></div>
    ...
    const data = {labels:
        ...
        const doughnutLabel = {
          ...
          // The ctx is the rendering context of the canvas on which the chart is drawn.
            ...
            ctx.fillText("Total Incidents: " + data.datasets[1].data.reduce((total, count) => total + count, 0), xCoor, yCoor + 5);           
          }
        }
