<template>
  <div class="chart5-inner-container">
    <div class="chartfive-container"><canvas id="myChartFive"></canvas></div>
    <div class="chartfive2-container-outer"><p id="titlechart5_2">Audits With Satisfactory Ratings Against Total</p>
  ...
  gradientSegment.addColorStop(1,'green');
    ...
    const plugin2 = {
        ...
        afterDatasetsDraw: (chart, args, options) => {
            ...
            ctx.textAlign = 'left'
            ctx.fillText('0',left+15,yCoor+ 3)
            ctx.fillText((this.countAudits[0]+this.countAudits[1]+this.countAudits[2]+this.countAudits[3]),right-30,yCoor+ 3)
